...
PlasmaExtras.PlasmoidHeading {
    ...
    PC3.TabBar {
        ...
        property real tabWidth: Math.max(applicationsTab.implicitWidth, placesTab.implicitWidth, settingsTab.implicitWidth)
        ...
        PC3.TabButton {
            ...
            text: i18nc("@title:tab kickoff sidebar tab", "Main") // qmllint disable unqualified
        ...
        PC3.TabButton {
            ...
            icon.height: Kirigami.Units.iconSizes.smallMedium
            icon.name: "compass"
            text: i18nc("@title:tab kickoff sidebar tab", "All Apps") // qmllint disable unqualified
        }
        PC3.TabButton {
            id: settingsTab
            width: tabBar.tabWidth
            ...
            icon.height: Kirigami.Units.iconSizes.smallMedium
            icon.name: "configure"
            text: i18nc("@title:tab kickoff sidebar tab", "Settings") // qmllint disable unqualified
        }
