...
namespace SDDM {
    ...
    private:
        ...
        QPointer<AuthPrompt> m_pendingPrompt;   // HasH 2FA: prompt awaiting a greeter response
        Greeter *m_greeter { nullptr };

    private slots:
        void slotRequestChanged();
        void slotPromptResponse(QLocalSocket *socket, const QString &answer);   // HasH 2FA
