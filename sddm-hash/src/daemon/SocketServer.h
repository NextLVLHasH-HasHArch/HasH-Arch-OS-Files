...
namespace SDDM {
    ...
    public slots:
        ...
        void promptRequest(QLocalSocket *socket, const QString &message, bool secret);  // HasH 2FA
    ...
    signals:
        ...
        void connected();
        void promptResponse(QLocalSocket *socket, const QString &answer);  // HasH 2FA
