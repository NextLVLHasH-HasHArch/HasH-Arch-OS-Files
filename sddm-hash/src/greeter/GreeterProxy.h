...
namespace SDDM {
    ...
    public slots:
        ...
        void respondToPrompt(const QString &answer);   // HasH 2FA: send the popup's code to the daemon
    ...
    signals:
        ...
        void promptRequested(const QString &message, bool secret);   // HasH 2FA: PAM asked for a code
